		...
		editor.addButton('mfnsc', {
			...
			menu : [ {
				...
				menu : [ {
					...
					text : 'Pricing Item',
					onclick : function() {
						editor.insertContent('[pricing_item image="" title="" currency="" price="" period="" subtitle="" link_title="" link="" icon="" featured="0" style="box" animate=""]<ul><li><strong>List</strong> item</li></ul>[/pricing_item]');
					}
				}, {
					text : 'Progress Bars',
					onclick : function() {
